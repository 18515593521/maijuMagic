...
Page({
  ...
  getPeopleList: function (searchPage) {
    ...
    wx.request({
      url: app.globalData.domainName + '/app/selectInviterPage',  //接口地址 
      data: {           //请求参数 
        page: searchPage,
  ...
  getRedMoney: function (e) {
    ...
    wx.request({
      url: app.globalData.domainName + '/app/addRedCashWithdrawal',  //接口地址 
      data: {           //请求参数 
        appid: app.globalData.appInfo.appId,
        appid1: app.globalData.appInfo.appId,
        id:item.id
      },
      method: 'POST',
      dataType: 'json',
