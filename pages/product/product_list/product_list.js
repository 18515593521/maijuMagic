...
Page({
  ...
  onShareAppMessage: function () {
    var thisPage = this;
    var param = "P1=B&P4=" + app.globalData.customerInfo.id + "&seriesIdList=" + JSON.stringify(thisPage.data.seriesIdList) + "&searchText=" + thisPage.data.searchText ;
  ...
  getProductList: function (searchPage) {
    ...
    wx.request({
      url: app.globalData.domainName + '/app/queryshopallproducts',  //接口地址
      data: {           //请求参数
        page: searchPage,
